...
## Обзор проекта
**DartBrig Pro** — это профессиональная система управления рейтингами дартс-турниров. 
**Стек технологий:**
...
- Интерфейс администратора читается полностью (все заголовки и плитки видны без обрезки).
