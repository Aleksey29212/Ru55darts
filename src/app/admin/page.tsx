                    ...
                    <Button key={section.href} asChild variant="outline" className={cn(
                        ...
                        <Link href={section.href} className="flex items-center gap-4 w-full text-left">
                            ...
                            <div className="flex flex-col flex-1 min-w-0">
                                <span className="font-headline text-[10px] md:text-[13px] lg:text-sm tracking-tight leading-tight text-white group-hover:text-primary transition-colors line-clamp-2 uppercase break-words hyphens-auto">
                                    {section.title}
                                </span>
