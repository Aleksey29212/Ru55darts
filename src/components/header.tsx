    ...
    <header className="sticky top-0 z-50 w-full border-b-2 border-primary/30 bg-background/90 backdrop-blur-xl">
      <div className="container flex h-16 items-center px-2 md:px-8">
        ...
        <nav className="ml-auto flex items-center gap-1 sm:gap-2 md:gap-3">
          <div className="hidden lg:flex items-center gap-1 bg-black/40 p-1.5 rounded-2xl border border-white/10 mr-1 md:mr-2 shadow-inner">
            <Button
              variant="ghost"
              size="sm"
              className={cn(
                "h-9 w-10 px-0 rounded-xl transition-all duration-300 interactive-scale",
                isClient && !isMobile ? "bg-primary text-primary-foreground shadow-lg" : "text-muted-foreground opacity-40 hover:opacity-100"
              )}
            ...
            <Button
              ...
              className={cn(
                "h-9 w-10 px-0 rounded-xl transition-all duration-300 interactive-scale",
                isClient && isMobile ? "bg-blue-600 text-white shadow-[0_0_15px_rgba(37,99,235,0.5)]" : "text-muted-foreground opacity-40 hover:opacity-100"
              )}
