                            ...
                            <AccordionContent className="bg-black/40 border-t border-white/5 animate-in slide-in-from-top-2 duration-300">
                                <div className="p-6 space-y-8">
                                    <div className="grid grid-cols-3 gap-3 w-full">
                                        <div className="flex flex-col items-center justify-center bg-white/[0.03] border border-white/10 rounded-2xl py-4 px-1 shadow-inner h-full transition-all hover:bg-white/[0.06] active:scale-95">
                                    ...
                                    <Button asChild className={cn(
                                        "w-full h-16 rounded-[2rem] font-bold shadow-2xl interactive-scale text-xl text-white group transition-all",
                                        theme.accent
                                    )} size="lg">
